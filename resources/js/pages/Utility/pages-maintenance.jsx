...
const PagesMaintenance = () => {
  ...
  //meta title
  document.title = "Maintenance | MCL PPM";
                ...
                <Row>
                  <Col md={4}>
                    <Card className="mt-4 maintenance-box">
                      <CardBody>
                        <i className="fab fa-broadcast mb-4 h1 text-primary"></i>
                  ...
                  <Col md={4}>
                    <Card className="mt-4 maintenance-box">
                      <CardBody>
                        <i className="fab fa-time-five mb-4 h1 text-primary"></i>
                  ...
                  <Col md={4}>
                    <Card className="mt-4 maintenance-box">
                      <CardBody>
                        <i className="fab fa-envelope mb-4 h1 text-primary"></i>
                        <h5 className="font-size-15 text-uppercase">
