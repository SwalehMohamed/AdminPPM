                                    ...
                                    <i
                                        className={
                                            Chat_Box_User_Status === "online"
                                                ? "fab fa-circle text-success align-middle me-2"
                                                : Chat_Box_User_Status === "intermediate"
                                                    ? "fab fa-circle text-warning align-middle me-1"
                                                    : "fab fa-circle align-middle me-1"
                                        }
                                    />
                                ...
                                <ul className="list-inline user-chat-nav text-end mb-0">
                                    <li className="list-inline-item d-none d-sm-inline-block">
                                        <Dropdown className="me-1" isOpen={search_Menu} toggle={toggleSearch}>
                                            <DropdownToggle className="btn nav-btn" tag="a">
                                                <i className="fab fa-search-alt-2" />
                                            </DropdownToggle>
                                    ...
                                    <li className="list-inline-item">
                                        <Dropdown isOpen={other_Menu} toggle={toggleOther}>
                                            <DropdownToggle className="btn nav-btn" tag="a">
                                                <i className="fab fa-dots-horizontal-rounded" />
                                            </DropdownToggle>
                                                                        ...
                                                                        <div className="conversation-list">
                                                                            <UncontrolledDropdown>
                                                                                <DropdownToggle href="#!" tag="a" className="dropdown-toggle">
                                                                                    <i className="fab fa-dots-vertical-rounded" />
                                                                                </DropdownToggle>
                                                                                <DropdownMenu>
                                                                            ...
                                                                            <div className="ctext-wrap">
                                                                                ...
                                                                                {userMsg.time !== 0 && <p className="chat-time mb-0"><i className="fab fa-time-five align-middle me-1"></i>{userMsg.time}</p>}
                                                                            </div>
                                                                        </div>
                                                                    </li>
                                                                );
                            ...
                            <div className="replymessage-block mb-0 d-flex align-items-start">
                                ...
                                <div className="flex-shrink-0">
                                    <button type="button" id="close_toggle" className="btn btn-sm btn-link mt-n2 me-n3 fs-18" onClick={() => setSelectedImage(null)}>
                                        <i className="fa fa-x align-middle"></i>
                                    </button>
                                </div>
                            </div>
                        }
                                        ...
                                        <div className="chat-input-links">
                                            <ul className="list-inline mb-0">
                                                <li className="list-inline-item" onClick={() => setEmoji(!emoji)}>
                                                    <Link to="#">
                                                        <i className="fab fa-emoticon-happy-outline me-1" id="Emojitooltip" />
                                                ...
                                                <li className="list-inline-item">
                                                    <label htmlFor="imageInput" style={{ color: "#556ee6", fontSize: 16 }}>
                                                        <i className="fab fa-file-image-outline me-1" id="Imagetooltip" />
                                                ...
                                                <li className="list-inline-item">
                                                    <Link to="#">
                                                        <i className="fab fa-file-document-outline" id="Filetooltip" />
