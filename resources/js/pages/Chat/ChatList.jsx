                ...
                <div >
                        ...
                        <div className="d-flex">
                            <div className="flex-grow-1">
                                ...
                                <p className="text-muted mb-0">
                                    <i className="fab fa-circle text-success align-middle me-2" /> Active
                                </p>
                            </div>
                            ...
                            <div>
                                <Dropdown isOpen={menu1} toggle={() => setMenu1(!menu1)} className="chat-noti-dropdown active">
                                    <DropdownToggle tag="a" className="btn">
                                        <i className="fab fa-bell fa-tada"></i>
                                    </DropdownToggle>
                    ...
                    <div className="search-box chat-search-box py-4">
                        <div className="position-relative">
                            ...
                            <i className="fab fa-search-alt search-icon" />
                        </div>
                    </div>
                        ...
                        <Nav pills justified>
                            ...
                            <NavItem>
                                <NavLink className={classnames({ active: activeTab === "contacts", })} onClick={() => { toggleTab("contacts"); }}>
                                    <i className="fab fa-book-content font-size-20 d-sm-none" />
                                                            ...
                                                            <Link to="#" onClick={() => userChatOpen(chat)}>
                                                                <div className="d-flex">
                                                                    <div className="align-self-center me-3">
                                                                        <i className={`fab fa-circle font-size-10 ${chat.status === "online" ? "text-success" : chat.status === "intermediate" ? "text-warning" : ""}`} />
                                                                    </div>
